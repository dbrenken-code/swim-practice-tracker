...
public class Organization
{
  ...
  public Organization(String aName)
  {
    name = aName;
  ...
  public boolean addGroup(Group aGroup)
  {
    ...
    groups.add(aGroup);
    if (aGroup.indexOfOrganization(this) != -1)
    {
      wasAdded = true;
    }
    else
    {
      wasAdded = aGroup.addOrganization(this);
      if (!wasAdded)
      {
  ...
  public boolean removeGroup(Group aGroup)
  {
    ...
    {
      wasRemoved = aGroup.removeOrganization(this);
      if (!wasRemoved)
      {
  ...
  public void delete()
  {
    ...
    {
      aGroup.removeOrganization(this);
    }
  }
